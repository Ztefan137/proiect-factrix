...
add({12, "rock",     3,2, 3,3, true, false, "../assets/decoratives/rock1.png", 0});
add({13, "drill",    2,2, 2,2, true,  true,  "../assets/buildings/drill.png", 4});
add({14, "belt",     1,1, 1,1, true,  true,  "../assets/buildings/null.png", 0});
